...
generateBtn.addEventListener("click", writePassword);
  if (generateBtn) {
  var useLowerCase = prompt("Do you want to include lowercase characters?")

var useUpperCase = prompt("Do you want to include uppercase characters?")

var useNumeric = prompt("Do you want to include special characters?")

useSpecial = prompt("Do you want to include number characters?")
}
